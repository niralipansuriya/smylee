...
public class GPUCameraRecorder {
    ...
    private SurfaceTexture surfaceTextureCreated;
    ...
    GPUCameraRecorder(
        ...
        glPreviewRenderer.setSurfaceCreateListener(new GlPreviewRenderer.SurfaceCreateListener() {
            ...
            public void onCreated(SurfaceTexture surfaceTexture) {
                surfaceTextureCreated = surfaceTexture;
    ...
    public void switchFlashMode(ImageView m_flash_light) {
        if (!flashSupport) return;
        if (cameraHandler != null) {
            cameraHandler.switchFlashMode(m_flash_light);
        }
    }
    ...
    public void flashOFF() {
        if (!flashSupport) return;
        if (cameraHandler != null) {
            cameraHandler.SwitchOffFlashMode();
        }
    }
    ...
    public void setCameraLens(LensFacing lens) {
        /*if (cameraHandler != null) {
            cameraHandler.stopPreview(false);
        }
        this.cameraHandler = null;
        this.lensFacing = lens;
        startPreview(surfaceTextureCreated);*/
        stopAndSwitchCamera(lens);
    }

    private void stopAndSwitchCamera(final LensFacing lens) {
