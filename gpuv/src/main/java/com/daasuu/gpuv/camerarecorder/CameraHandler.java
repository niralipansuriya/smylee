...
public class CameraHandler extends Handler {
    ...
    private static final int MSG_FLASH_OFF = 6;
    ...
    void switchFlashMode(ImageView m_flash_light) {
        m_flash_light = m_flash_light;
        sendMessage(obtainMessage(MSG_SWITCH_FLASH));
    }

    void SwitchOffFlashMode() {
        sendMessage(obtainMessage(MSG_FLASH_OFF));
    }
    ...
    public void handleMessage(final Message msg) {
        switch (msg.what) {
            ...
            case MSG_SWITCH_FLASH:
                ...
                if (thread != null) {
                    thread.switchFlashMode(m_flash_light);
                }
                break;
            case MSG_AUTO_FOCUS:
                if (thread != null) {
