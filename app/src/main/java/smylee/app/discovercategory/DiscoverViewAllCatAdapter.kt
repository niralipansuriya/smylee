...
class DiscoverViewAllCatAdapter(
    context: Context,
    categoryVideo: ArrayList<ForYouResponse>,
    USER_ID: String,
    val manageClick: ManageClick
) : RecyclerView.Adapter<DiscoverViewAllCatAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context)
            .inflate(R.layout.adapter_discover_details, parent, false)
        return ViewHolder(v)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (categoryVideo!!.get(position).profile_pic != null && categoryVideo!!.get(position).profile_pic != "") {
            holder.iv_pic.scaleType = ImageView.ScaleType.CENTER_CROP
            Glide.with(context!!)
                .load(categoryVideo!!.get(position).profile_pic)
                .error(R.drawable.userpicfinal)
                .into(holder.iv_pic)
        } else {
            holder.iv_pic.scaleType = ImageView.ScaleType.FIT_CENTER
            holder.iv_pic.setImageResource(R.drawable.userpicfinal)
        }
        if (categoryVideo!![position].post_video_thumbnail_compres!!.contains("GIF") || categoryVideo!![position].post_video_thumbnail_compres!!.contains(
            ...
            if (categoryVideo!![position].post_height != null && categoryVideo!![position].post_height != null) {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            if (categoryVideo != null && categoryVideo.size > 0) {
                // txt_title.setText(categoryVideo[pos].post_title)
                ...
                txt_title.setText(categoryVideo[pos].profile_name)

                txt_desc.setText(categoryVideo[pos].post_title)
