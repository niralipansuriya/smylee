...
public class PinEntryEditText extends AppCompatEditText {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (mIsDigitSquare) {
            ...
            setMeasuredDimension(resolveSizeAndState(measuredWidth, widthMeasureSpec, 1), resolveSizeAndState(measuredHeight, heightMeasureSpec, 0));
        } else {
    ...
    private void animatePopIn() {
        ...
        if (Objects.requireNonNull(getText()).length() == mMaxLength && mOnPinEnteredListener != null) {
