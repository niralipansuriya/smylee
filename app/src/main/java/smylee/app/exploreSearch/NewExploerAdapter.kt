...
class NewExploerAdapter(
    context: Context,
    categoryVideo: ArrayList<ForYouResponse>?,
    USER_ID: String
) : RecyclerView.Adapter<NewExploerAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: NewExploerAdapter.ViewHolder, position: Int) {
        holder.bindItems(
            position,
            categoryVideo,
            context,
